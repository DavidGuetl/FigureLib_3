...
include INFUSIONS."figurelib/templates/template_figurelib.php";
		...
		if ($max_rows != 0) {
			...
			if (dbrows($result) > 0) {
				while ($data = dbarray($result)) {
					...
					$data['figure'] = array(
						'link' => INFUSIONS."figurelib/figures.php?figure_id=".$_GET['figure_id']."&amp;figure_id=".$data['figure_id'],
