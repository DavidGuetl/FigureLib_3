...
// ########### 	folgende User haben die Figure  ##################################				
					...
					$locale['userfigure_005'] ="FIGURE STATS";
					$locale['userfigure_006'] ="Your Collection";
					$locale['userfigure_007'] ="No members have this Figure - be the first and <a href='".BASEDIR."register.php'>REGISTER HERE</a>";
