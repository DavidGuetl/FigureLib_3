...
// File Field "Images" /////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
        ...
        if (dbrows($resultimage)) {
            $data = dbarray($resultimage);
        } else {
            redirect(FUSION_SELF.$aidlink);
        }
	
	
		if ($data['figure_images_image'] != "" && $data['figure_images_thumb'] != "") {
        $image_thumb = get_figure_image_path($data['figure_images_image'], $data['figure_images_thumb']);
        if (!$image_thumb) {
        ...
        echo "</div>\n</div>\n";
        echo "<input type='hidden' name='figure_images_image' value='".$data['figure_images_image']."' />\n";
        echo "<input type='hidden' name='figure_images_thumb' value='".$data['figure_images_thumb']."' />\n";
    } else {
