			...
			// FORM BEGINNING #######################################################################################################################
				...
				openside('');
						...
						// Checkbox "Terms"  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									...
									// ['figurelib/admin/figurelib.php_073'] = "Submitter read and agree to the terms and conditions.";
									
									
								echo form_checkbox("figure_agb", $locale['figurelib/admin/figurelib.php_073'], $data['figure_agb'], array(
									"inline" => TRUE,
									"required" => TRUE,
